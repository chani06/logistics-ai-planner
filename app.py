...
def predict_trips(test_df, model_data):
    ...
    # 🎯 Phase 1.5: (ลบแล้ว - Skip เพื่อความเร็ว, Route Pickup ทำโดย algorithm หลักแล้ว)
    ...
    # 🚨 Phase 1.76: (ลบแล้ว - ซ้ำกับ split_mixed_regions ที่เรียกก่อนหน้า)
    # แยก nearby/far ทำโดย split_mixed_regions แล้ว
    ...
    # 🔄 Phase 4: (Skip เพื่อความเร็ว - nearby/far แยกโดย split_mixed_regions และ Phase 3 แล้ว)
    # 🚨 Phase 5: (Skip เพื่อความเร็ว - Distance Optimization ทำโดย algorithm หลักแล้ว)
