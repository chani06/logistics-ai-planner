...
LOGISTICS_ZONES = {
    ...
    'ZONE_BKK_เหนือ': {
        ...
        'districts': [
            'หลักสี่', 'ดอนเมือง', 'สายไหม', 'จตุจักร', 'พญาไท', 'ดินแดง', 'ห้วยขวาง',
            'ดุสิต', 'บางซื่อ', 'บางเขน', 'ลาดพร้าว', 'วังทองหลาง', 'คันนายาว',
        ],
        'highway': '1/9',
        'priority': 95,
        'distance_from_dc_km': 50,
        'description': 'กทม.เหนือ ดอนเมือง-จตุจักร-ดุสิต-ลาดพร้าว'
    },
    'ZONE_BKK_กลาง': {
        'provinces': ['กรุงเทพมหานคร'],
        'districts': [
            'ปทุมวัน', 'วัฒนา', 'คลองเตย', 'ราชเทวี', 'บางรัก', 'สาทร', 'ยานนาวา',
            'พระนคร', 'ป้อมปราบศัตรูพ่าย', 'สัมพันธวงศ์', 'พระโขนง', 'บางนา', 'สวนหลวง',
        ],
        'highway': 'CBD',
        'priority': 96,
        'distance_from_dc_km': 55,
        'description': 'กทม.กลาง CBD-สีลม-สุขุมวิท-พระนคร'
    },
    'ZONE_BKK_ตะวันตก': {
        'provinces': ['กรุงเทพมหานคร'],
        'districts': [
            'บางกอกน้อย', 'บางกอกใหญ่', 'ธนบุรี', 'คลองสาน',
            'ตลิ่งชัน', 'ทวีวัฒนา', 'ภาษีเจริญ', 'หนองแขม',
        ],
        'highway': '35/4',
        'priority': 97,
        'distance_from_dc_km': 58,
        'description': 'กทม.ตะวันตก ธนบุรี-ตลิ่งชัน-ภาษีเจริญ'
    },
    'ZONE_BKK_ใต้': {
        'provinces': ['กรุงเทพมหานคร'],
        'districts': [
            'บางแค', 'ราษฎร์บูรณะ', 'ทุ่งครุ', 'จอมทอง', 'บางบอน', 'บางขุนเทียน',
            'บางคอแหลม', 'สาธร',
        ],
        'highway': '35',
        'priority': 98,
        'distance_from_dc_km': 60,
        'description': 'กทม.ใต้ พระราม 2-บางขุนเทียน-ราษฎร์บูรณะ'
    },
    'ZONE_BKK_ตะวันออก': {
        'provinces': ['กรุงเทพมหานคร'],
        'districts': [
            'บางกะปิ', 'บึงกุ่ม', 'สะพานสูง', 'ลาดกระบัง', 'มีนบุรี', 'คลองสามวา', 'หนองจอก',
            'ประเวศ', 'สาวสวรรค์', 'คลองเตย',
        ],
        'highway': '3/9',
        'priority': 99,
        'distance_from_dc_km': 45,
        'description': 'กทม.ตะวันออก ลาดกระบัง-มีนบุรี-ประเวศ'
    },
    'ZONE_NEARBY_นนทบุรี': {
        'provinces': ['นนทบุรี'],
