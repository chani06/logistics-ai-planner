    ...
    while all_codes:
        ...
        while all_codes:
            ...
            for code in all_codes:
                ...
                # 🔥 เช็คว่าจังหวัดติดกันหรือไม่ (อนุญาตให้ข้ามภาคได้ถ้าติดกัน)
                provinces_adjacent = are_adjacent_provinces(last_province, code_province)
                same_province = (code_province == last_province)
                
                # 🚨 กฎการรวมสาขาข้ามภาค:
                # 1. จังหวัดเดียวกัน → รวมได้
                # 2. จังหวัดติดกัน → รวมได้ (เช่น นครราชสีมา + สระบุรี)
                # 3. ภาคไกล + ภาคกลาง ที่ไม่ติดกัน → ห้ามรวม
                if not same_province and not provinces_adjacent:
                ...
                # - จังหวัดเดียวกัน/ติดกัน + อำเภอเดียวกัน → ยืดหยุ่นระยะเป็น 80km
                # - จังหวัดติดกัน → ยืดหยุ่นระยะเป็น 60km
                ...
                if same_subdistrict:
                    ...
                    if dist_from_last > 80:
                        continue
                elif provinces_adjacent:
                    # 🔥 จังหวัดติดกัน → ยืดหยุ่นเป็น 60km
