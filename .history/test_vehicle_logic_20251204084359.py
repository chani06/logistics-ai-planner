...
7. บังคับข้อจำกัดสาขา: 4W/JB ≤12 สาขา, 6W ไม่จำกัด
"""
...
if max_branches_check:
    # ตรวจสอบ MAX_BRANCHES_PER_TRIP
    if "MAX_BRANCHES_PER_TRIP = 12" in app_code:
        print("✅ พบ MAX_BRANCHES_PER_TRIP = 12 (สำหรับ 4W/JB)")
    
    # ตรวจสอบว่า 6W ไม่จำกัด
    if "float('inf')" in app_code or "6W ไม่จำกัด" in app_code:
        print("✅ พบข้อจำกัด: 6W ไม่จำกัดสาขา")
    
    # ตรวจสอบใน Phase 2.1
    if "max_branches = 12 if target_vehicle in ['4W', 'JB']" in app_code:
        print("✅ ถูกต้อง! Phase 2.1 แยกข้อจำกัดตามประเภทรถ (4W/JB ≤12, 6W ไม่จำกัด)")
...
checks = {
    ...
    "Branch restrictions - 4W/JB ≤12 สาขา, 6W ไม่จำกัด": "max_branches = 12 if target_vehicle in ['4W', 'JB'] else float('inf')" in app_code,
