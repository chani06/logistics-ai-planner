...
def predict_trips(test_df, model_data):
    ...
    # ⚡ Skip ถ้ามีทริปมากเกิน 10 ทริป หรือใช้เวลามากกว่า 20 วินาที (ประหยัดเวลา)
    unique_trips = test_df['Trip'].unique()
    if len(unique_trips) > 10 or time.time() - start_time > 20:
    ...
    # ⚡ Early stopping - ถ้าใช้เวลามากกว่า 28 วินาที
