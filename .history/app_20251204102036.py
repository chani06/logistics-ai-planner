...
def predict_trips(test_df, model_data):
    ...
    for trip_num in test_df['Trip'].unique():
        ...
        # 🚛 กรุงเทพ+ปริมณฑล (nearby) → บังคับห้าม 6W เสมอ
        elif all_nearby:
            # ลอง 4W ก่อน
    ...
    # 🔄 Phase 4: บังคับเปลี่ยน nearby จาก 6W → JB/4W และกระจายทริปน้อย
    low_util_trips = []
    ...
    # กระจายทริปที่น้อยเกินไปไปรวมกับทริปอื่น (แบบเร็ว)
    for low_trip in low_util_trips:
