...
def predict_trips(test_df, model_data):
    ...
    for trip in all_trips:
        ...
        # 🆕 เพิ่ม region_group สำหรับการเรียง
    ...
    # 🔄 เรียงตามกลุ่มภาค → จังหวัด → ระยะทาง (ป้องกันทริปกระโดดข้ามกลุ่มภาค)
    ...
    all_trips.sort(key=lambda x: (
        ...
        x.get('region_group', 'zzz'),  # 2. กลุ่มภาค (เหนือตอนบน, เหนือตอนล่าง ฯลฯ)
