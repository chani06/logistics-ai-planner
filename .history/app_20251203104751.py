        ...
        for i in range(len(all_trips)):
            ...
            for j in range(i + 1, len(all_trips)):
                ...
                if (combined_w <= LIMITS['6W']['max_w'] * BUFFER and 
                    ...
                    # คุ้ม = ถ้าทั้ง 2 ทริปใช้รถต่ำกว่า 60% หรือ มีสาขารวมกันน้อยกว่า 8
                    should_merge = False
                    ...
                    # เงื่อนไข 3: รวมแล้วได้สาขา ≤8 และทั้ง 2 ทริปใช้รถต่ำกว่า 70%
                    elif combined_count <= 8 and trip1['util'] < 70 and trip2['util'] < 70:
                        should_merge = True
