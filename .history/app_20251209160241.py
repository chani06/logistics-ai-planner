...
def predict_trips(test_df, model_data):
    ...
    distance_swaps = 0
    max_distance_swaps = 50  # จำกัดจำนวนการสลับ
    
    for iteration in range(3):  # ทำ 3 รอบ
        ...
        for trip_num in test_df['Trip'].unique():
            ...
            # ถ้าสาขาไกลเกิน MAX_DISTANCE_IN_TRIP/2 จาก centroid → ลองหาทริปที่เหมาะกว่า
            if farthest_dist > MAX_DISTANCE_IN_TRIP / 2 and farthest_code:
                ...
                for other_trip in test_df['Trip'].unique():
                    ...
                    if dist_to_other < best_new_dist - 10:  # ต้องใกล้กว่าอย่างน้อย 10km
