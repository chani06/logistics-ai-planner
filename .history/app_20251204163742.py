...
def get_region_type(province):
    ...
    Returns:
        str: 'nearby' (ใกล้ - ใช้ 4W/JB), 'far' (ไกล - ใช้ 6W), 
             'very_far' (ไกลมาก - ภาคเหนือ/ใต้ทั้งหมด - ต้อง 6W เท่านั้น), 'unknown'
    """
    if pd.isna(province):
        return 'unknown'
    ...
    # 🚛 พื้นที่ไกลมากๆ (ภาคเหนือทั้งหมด + ภาคใต้ทั้งหมด) → ต้องใช้ 6W เท่านั้น
    very_far_provinces = [
        # ภาคเหนือตอนบน
        'เชียงใหม่', 'เชียงราย', 'แม่ฮ่องสอน', 'น่าน', 'พะเยา', 'ลำปาง', 'ลำพูน', 'แพร่',
        # ภาคเหนือตอนล่าง
        'กำแพงเพชร', 'ตาก', 'พิจิตร', 'พิษณุโลก', 'สุโขทัย', 'อุตรดิตถ์', 'เพชรบูรณ์',
        # ภาคใต้ฝั่งอ่าวไทย
        'ชุมพร', 'นครศรีธรรมราช', 'พัทลุง', 'ยะลา', 'สงขลา', 'สุราษฎร์ธานี', 'ปัตตานี', 'นราธิวาส',
        # ภาคใต้ฝั่งอันดามัน
...
def predict_trips(test_df, model_data):
    ...
    if time.time() - start_time > 55:
        ...
        # 🚛 เช็คว่ามีจังหวัดภาคเหนือหรือใต้หรือไม่ → บังคับ 6W
        has_north_or_south = has_very_far_province
        ...
        elif has_north_or_south:
            # 🚛 ภาคเหนือหรือใต้ → บังคับใช้ 6W เท่านั้น!
            very_far = True
            max_allowed = '6W'  # บังคับให้ใช้ 6W
        else:
