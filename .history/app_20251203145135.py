...
def predict_trips(test_df, model_data):
        ...
        if very_far:
            ...
            if max_allowed == '4W':
                ...
                if cube_util_4w > 100 and max_allowed in ['4W', 'JB']:
                    recommended = 'JB'
                # 4W Cube เต็มดี (≥80%) และน้ำหนักไม่เกินมาก → ใช้ 4W
                elif cube_util_4w >= 80 and weight_util_4w <= 130:
                    recommended = '4W'
            ...
            if not recommended and max_allowed in ['4W', 'JB']:
                ...
                if cube_util_jb > 100:
                    recommended = '6W'
                # JB Cube เต็มดี (≥70%) และน้ำหนักไม่เกินมาก → ใช้ JB
                elif cube_util_jb >= 70 and weight_util_jb <= 130:
                    recommended = 'JB'
    ...
    for trip_num in sorted(test_df['Trip'].unique()):
        ...
        if should_split:
            ...
            # ตรวจสอบว่าทั้ง 2 กลุ่มใช้รถเป้าหมายได้และมีประสิทธิภาพ (Cube ≥70%, น้ำหนัก ≤130%)
            g1_ok = g1_cube_util <= 130 and g1_weight_util <= 130 and g1_cube_util >= 70
            g2_ok = g2_cube_util <= 130 and g2_weight_util <= 130 and g2_cube_util >= 70
