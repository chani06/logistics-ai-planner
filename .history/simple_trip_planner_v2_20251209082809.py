...
LIMITS = {
    '6W': {'max_c': 20, 'min_c': 18, 'max_w': 7000, 'max_drops': 999},  # 6W ต้อง 18-20 คิว, ไม่เกิน 7000kg, ไม่จำกัด drops
    'JB': {'max_c': 7, 'max_w': 3500, 'max_drops': 7},  # JB ≤7 คิว, ≤7 drops
    '4W': {'max_c': 5, 'max_w': 2500, 'max_drops': 12}  # 4W: 5คิว(PT)/3-4คิว(Mix), ไม่เกิน 2500kg
}
