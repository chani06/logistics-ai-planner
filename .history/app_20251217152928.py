    ...
    while all_codes:
        ...
        while all_codes:
            ...
            for code in all_codes:
                ...
                # 🆕 จังหวัดชายแดนที่สามารถรวมกันได้ (ภาคไกลติดภาคกลาง)
                # จังหวัดภาคกลางที่ติดกับภาคไกล
                border_nearby = ['สระบุรี', 'ลพบุรี', 'นครนายก', 'ปราจีนบุรี', 'สระแก้ว', 
                                 'ชลบุรี', 'ระยอง', 'จันทบุรี', 'ตราด',
                                 'กาญจนบุรี', 'ราชบุรี', 'เพชรบุรี', 'ประจวบคีรีขันธ์']
                # จังหวัดภาคไกลที่ติดกับภาคกลาง
                border_far = ['นครราชสีมา', 'ชัยภูมิ', 'บุรีรัมย์', 'สุรินทร์',
                              'ชุมพร', 'ระนอง', 'สุราษฎร์ธานี',
                              'ตาก', 'กำแพงเพชร', 'พิจิตร', 'เพชรบูรณ์']
                
                # เช็คว่าเป็นจังหวัดชายแดนหรือไม่
                seed_is_border = any(b in str(seed_province) for b in border_nearby + border_far)
                code_is_border = any(b in str(code_province) for b in border_nearby + border_far)
                both_border = seed_is_border and code_is_border
                
                # 🚨 กฎการรวมภาค:
                # 1. ถ้าทั้งคู่เป็นจังหวัดชายแดน → รวมได้ (จะใช้ JB)
                # 2. ถ้าภาคไกลลึกๆ → ห้ามรวมกับภาคกลาง
                if not both_border:
                    if is_far_region and code_region == 'nearby':
                        continue  # ภาคไกลลึกๆ ห้ามรวมกับภาคกลาง
                    elif seed_region == 'nearby' and code_region in ['north', 'south', 'far']:
                        continue  # ภาคกลางห้ามรวมกับภาคไกลลึกๆ
