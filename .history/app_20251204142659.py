...
# ⚡ SPEED MODE: ข้าม heavy phases สำหรับการทดสอบ
SKIP_HEAVY_PHASES = False  # Set True to skip optimization phases for faster testing
...
def predict_trips(test_df, model_data):
    ...
    # ⚡ แปลง Code เป็น string เพื่อป้องกัน type error
    ...
    # ===============================================
    # ⚡ SKIP optimize_branch_placement for speed
    # ===============================================
    ...
    merge_count = 0
    iteration = 0
    max_iterations = 1  # ⚡ ลดเหลือ 1 รอบเท่านั้น (จาก 2)
    ...
    # ⚡ SKIP Phase 1.25, 1.5, 1.75 for speed - go directly to Phase 2
    
    # 🚨 ⚡ FAST MODE: ข้าม phase ที่ไม่จำเป็นเมื่อ SKIP_HEAVY_PHASES = True
    if SKIP_HEAVY_PHASES:
        # ข้ามทุก optimization phases ไปใช้ enforce_vehicle_constraints โดยตรง
        pass  # ไม่ทำอะไร ข้ามไปใช้ enforce ตอนท้าย
    else:
    ...
    # ⚡ SPEED: ข้าม Phase 2.5, 3, 4 - enforce_vehicle_constraints จะจัดการ
