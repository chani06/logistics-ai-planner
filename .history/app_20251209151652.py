        ...
        if location_col and truck_col:
            ...
            for _, row in df_info.iterrows():
                ...
                if code and truck_type and code != 'nan' and truck_type != 'NAN':
                    # แปลง 10W, 6WF, 4WF เป็น 6W, 4W
                    if '10W' in truck_type or '6W' in truck_type:
                        normalized_truck = '6W'
                    elif 'JB' in truck_type or 'JUMBO' in truck_type:
                        normalized_truck = 'JB'
                    elif '4W' in truck_type:
                        normalized_truck = '4W'
                    else:
                        normalized_truck = '6W'  # default
                    
                    AUTO_PLAN_TRUCK_LIMITS[code] = normalized_truck
            
            if AUTO_PLAN_TRUCK_LIMITS:
                st.info(f"📋 โหลดข้อจำกัดรถจากชีต info: {len(AUTO_PLAN_TRUCK_LIMITS)} สาขา")
