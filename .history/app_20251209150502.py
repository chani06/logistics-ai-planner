...
# 🏪 ขีดจำกัดพิเศษสำหรับ BU Punthai (ห้ามใช้ 6W)
LIMITS_PUNTHAI = {
    '4W': {'max_w': 2500, 'max_c': 5.0},   # ถ้าเกิน 5 ตัดเป็น JB
    'JB': {'max_w': 3500, 'max_c': 7.0},   # JB ใช้ได้ถึง 7 คิว (ไม่ใช่ 8)
    '6W': None  # ห้ามใช้ 6W สำหรับ Punthai
}
