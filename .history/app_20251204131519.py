...
def predict_trips(test_df, model_data):
    ...
    # ⚡ Skip Phase 2 entirely for speed
    downsize_count = 0
    region_changes = {'nearby_6w_to_jb': 0, 'far_keep_6w': 0, 'other': 0}
    
    # Skip to Phase 2 completed
    goto_phase_2_completed = True
    if goto_phase_2_completed:
    ...
    fix_count = 0
    split_count = 0
    goto_phase_2_1_completed = True
    if goto_phase_2_1_completed:
