...
def export_with_colors(result_df, output_file, original_file, sheet_name="2.Punthai"):
    ...
    # สีใหม่: เหลืองเข้มโทนส้ม
    yellow_dark = PatternFill(start_color='FFCC66', end_color='FFCC66', fill_type='solid')
    orange_light = PatternFill(start_color='FFDB99', end_color='FFDB99', fill_type='solid')
