...
# 🔥 อำเภอที่ติดกันข้ามจังหวัด (ทางผ่าน) - ครอบคลุมทุกจังหวัด
# เช่น สีคิ้ว (โคราช) ติดกับ มวกเหล็ก/แก่งคอย (สระบุรี)
ADJACENT_DISTRICTS = {
    # ==========================================
    # นครราชสีมา ↔ สระบุรี (ทางมิตรภาพ/ถนน 2)
    # ==========================================
    ('สีคิ้ว', 'นครราชสีมา'): [('มวกเหล็ก', 'สระบุรี'), ('แก่งคอย', 'สระบุรี'), ('วังม่วง', 'สระบุรี')],
    ('ปากช่อง', 'นครราชสีมา'): [('มวกเหล็ก', 'สระบุรี'), ('วังม่วง', 'สระบุรี')],
    ('มวกเหล็ก', 'สระบุรี'): [('สีคิ้ว', 'นครราชสีมา'), ('ปากช่อง', 'นครราชสีมา')],
    ('แก่งคอย', 'สระบุรี'): [('สีคิ้ว', 'นครราชสีมา')],
    ('วังม่วง', 'สระบุรี'): [('สีคิ้ว', 'นครราชสีมา'), ('ปากช่อง', 'นครราชสีมา')],
    
    # ==========================================
    # นครราชสีมา ↔ ชัยภูมิ
    # ==========================================
    ('ด่านขุนทด', 'นครราชสีมา'): [('บำเหน็จณรงค์', 'ชัยภูมิ'), ('เทพสถิต', 'ชัยภูมิ'), ('หนองบัวระเหว', 'ชัยภูมิ')],
    ('เทพารักษ์', 'นครราชสีมา'): [('เทพสถิต', 'ชัยภูมิ')],
    ('บำเหน็จณรงค์', 'ชัยภูมิ'): [('ด่านขุนทด', 'นครราชสีมา')],
    ('เทพสถิต', 'ชัยภูมิ'): [('ด่านขุนทด', 'นครราชสีมา'), ('เทพารักษ์', 'นครราชสีมา')],
    ('หนองบัวระเหว', 'ชัยภูมิ'): [('ด่านขุนทด', 'นครราชสีมา')],
    
    # ==========================================
    # นครราชสีมา ↔ บุรีรัมย์
    # ==========================================
    ('หนองบุญมาก', 'นครราชสีมา'): [('หนองกี่', 'บุรีรัมย์'), ('นางรอง', 'บุรีรัมย์'), ('ลำปลายมาศ', 'บุรีรัมย์')],
    ('โชคชัย', 'นครราชสีมา'): [('หนองกี่', 'บุรีรัมย์'), ('ลำปลายมาศ', 'บุรีรัมย์')],
    ('ครบุรี', 'นครราชสีมา'): [('นางรอง', 'บุรีรัมย์'), ('หนองหงส์', 'บุรีรัมย์')],
    ('หนองกี่', 'บุรีรัมย์'): [('หนองบุญมาก', 'นครราชสีมา'), ('โชคชัย', 'นครราชสีมา')],
    ('นางรอง', 'บุรีรัมย์'): [('หนองบุญมาก', 'นครราชสีมา'), ('ครบุรี', 'นครราชสีมา')],
    ('หนองหงส์', 'บุรีรัมย์'): [('ครบุรี', 'นครราชสีมา')],
    ('ลำปลายมาศ', 'บุรีรัมย์'): [('หนองบุญมาก', 'นครราชสีมา'), ('โชคชัย', 'นครราชสีมา')],
    
    # ==========================================
    # สระบุรี ↔ ลพบุรี
    # ==========================================
    ('พระพุทธบาท', 'สระบุรี'): [('โคกสำโรง', 'ลพบุรี'), ('เมืองลพบุรี', 'ลพบุรี')],
    ('เสาไห้', 'สระบุรี'): [('บ้านหมี่', 'ลพบุรี'), ('โคกสำโรง', 'ลพบุรี')],
    ('หนองแค', 'สระบุรี'): [('พัฒนานิคม', 'ลพบุรี')],
    ('โคกสำโรง', 'ลพบุรี'): [('พระพุทธบาท', 'สระบุรี'), ('เสาไห้', 'สระบุรี')],
    ('บ้านหมี่', 'ลพบุรี'): [('เสาไห้', 'สระบุรี')],
    ('พัฒนานิคม', 'ลพบุรี'): [('หนองแค', 'สระบุรี')],
    
    # ==========================================
    # สระบุรี ↔ นครนายก
    # ==========================================
    ('แก่งคอย', 'สระบุรี'): [('เมืองนครนายก', 'นครนายก'), ('บ้านนา', 'นครนายก')],
    ('วิหารแดง', 'สระบุรี'): [('เมืองนครนายก', 'นครนายก')],
    ('เมืองนครนายก', 'นครนายก'): [('แก่งคอย', 'สระบุรี'), ('วิหารแดง', 'สระบุรี')],
    ('บ้านนา', 'นครนายก'): [('แก่งคอย', 'สระบุรี')],
    
    # ==========================================
    # ชัยภูมิ ↔ ขอนแก่น
    # ==========================================
    ('ภูเขียว', 'ชัยภูมิ'): [('ชุมแพ', 'ขอนแก่น'), ('ภูผาม่าน', 'ขอนแก่น')],
    ('คอนสาร', 'ชัยภูมิ'): [('ชุมแพ', 'ขอนแก่น')],
    ('แก้งคร้อ', 'ชัยภูมิ'): [('ภูเวียง', 'ขอนแก่น')],
    ('ชุมแพ', 'ขอนแก่น'): [('ภูเขียว', 'ชัยภูมิ'), ('คอนสาร', 'ชัยภูมิ')],
    ('ภูผาม่าน', 'ขอนแก่น'): [('ภูเขียว', 'ชัยภูมิ')],
    ('ภูเวียง', 'ขอนแก่น'): [('แก้งคร้อ', 'ชัยภูมิ')],
    
    # ==========================================
    # ชัยภูมิ ↔ เพชรบูรณ์
    # ==========================================
    ('หล่มสัก', 'เพชรบูรณ์'): [('คอนสาร', 'ชัยภูมิ')],
    ('น้ำหนาว', 'เพชรบูรณ์'): [('คอนสาร', 'ชัยภูมิ')],
    ('คอนสาร', 'ชัยภูมิ'): [('หล่มสัก', 'เพชรบูรณ์'), ('น้ำหนาว', 'เพชรบูรณ์')],
    
    # ==========================================
    # ลพบุรี ↔ นครสวรรค์
    # ==========================================
    ('ชัยบาดาล', 'ลพบุรี'): [('ตาคลี', 'นครสวรรค์'), ('ท่าตะโก', 'นครสวรรค์')],
    ('ท่าหลวง', 'ลพบุรี'): [('ตาคลี', 'นครสวรรค์')],
    ('ตาคลี', 'นครสวรรค์'): [('ชัยบาดาล', 'ลพบุรี'), ('ท่าหลวง', 'ลพบุรี')],
    ('ท่าตะโก', 'นครสวรรค์'): [('ชัยบาดาล', 'ลพบุรี')],
    
    # ==========================================
    # นครราชสีมา ↔ ปราจีนบุรี / สระแก้ว
    # ==========================================
    ('ปักธงชัย', 'นครราชสีมา'): [('นาดี', 'ปราจีนบุรี'), ('วังน้ำเย็น', 'สระแก้ว')],
    ('วังน้ำเขียว', 'นครราชสีมา'): [('นาดี', 'ปราจีนบุรี')],
    ('นาดี', 'ปราจีนบุรี'): [('ปักธงชัย', 'นครราชสีมา'), ('วังน้ำเขียว', 'นครราชสีมา')],
    ('วังน้ำเย็น', 'สระแก้ว'): [('ปักธงชัย', 'นครราชสีมา')],
    
    # ==========================================
    # ปราจีนบุรี ↔ นครนายก / ฉะเชิงเทรา
    # ==========================================
    ('กบินทร์บุรี', 'ปราจีนบุรี'): [('องครักษ์', 'นครนายก'), ('สนามชัยเขต', 'ฉะเชิงเทรา')],
    ('เมืองปราจีนบุรี', 'ปราจีนบุรี'): [('บ้านนา', 'นครนายก')],
    ('องครักษ์', 'นครนายก'): [('กบินทร์บุรี', 'ปราจีนบุรี')],
    ('สนามชัยเขต', 'ฉะเชิงเทรา'): [('กบินทร์บุรี', 'ปราจีนบุรี')],
    
    # ==========================================
    # สระบุรี ↔ พระนครศรีอยุธยา
    # ==========================================
    ('หนองแค', 'สระบุรี'): [('วังน้อย', 'พระนครศรีอยุธยา'), ('อุทัย', 'พระนครศรีอยุธยา')],
    ('วิหารแดง', 'สระบุรี'): [('อุทัย', 'พระนครศรีอยุธยา')],
    ('วังน้อย', 'พระนครศรีอยุธยา'): [('หนองแค', 'สระบุรี')],
    ('อุทัย', 'พระนครศรีอยุธยา'): [('หนองแค', 'สระบุรี'), ('วิหารแดง', 'สระบุรี')],
    
    # ==========================================
    # บุรีรัมย์ ↔ สุรินทร์
    # ==========================================
    ('ประโคนชัย', 'บุรีรัมย์'): [('กาบเชิง', 'สุรินทร์'), ('สังขะ', 'สุรินทร์')],
    ('พลับพลาชัย', 'บุรีรัมย์'): [('เมืองสุรินทร์', 'สุรินทร์')],
    ('กาบเชิง', 'สุรินทร์'): [('ประโคนชัย', 'บุรีรัมย์')],
    ('สังขะ', 'สุรินทร์'): [('ประโคนชัย', 'บุรีรัมย์')],
    
    # ==========================================
    # สุรินทร์ ↔ ศรีสะเกษ / อุบลราชธานี
    # ==========================================
    ('ปราสาท', 'สุรินทร์'): [('ขุขันธ์', 'ศรีสะเกษ')],
    ('สังขะ', 'สุรินทร์'): [('ขุขันธ์', 'ศรีสะเกษ')],
    ('ขุขันธ์', 'ศรีสะเกษ'): [('ปราสาท', 'สุรินทร์'), ('สังขะ', 'สุรินทร์')],
    
    # ==========================================
    # ประจวบคีรีขันธ์ ↔ ชุมพร (ทางใต้)
    # ==========================================
    ('บางสะพาน', 'ประจวบคีรีขันธ์'): [('ปะทิว', 'ชุมพร'), ('เมืองชุมพร', 'ชุมพร')],
    ('บางสะพานน้อย', 'ประจวบคีรีขันธ์'): [('ปะทิว', 'ชุมพร')],
    ('ปะทิว', 'ชุมพร'): [('บางสะพาน', 'ประจวบคีรีขันธ์'), ('บางสะพานน้อย', 'ประจวบคีรีขันธ์')],
    
    # ==========================================
    # ฉะเชิงเทรา ↔ ชลบุรี
    # ==========================================
    ('พนมสารคาม', 'ฉะเชิงเทรา'): [('พนัสนิคม', 'ชลบุรี'), ('บ่อทอง', 'ชลบุรี')],
    ('บางปะกง', 'ฉะเชิงเทรา'): [('เมืองชลบุรี', 'ชลบุรี')],
    ('พนัสนิคม', 'ชลบุรี'): [('พนมสารคาม', 'ฉะเชิงเทรา')],
    ('บ่อทอง', 'ชลบุรี'): [('พนมสารคาม', 'ฉะเชิงเทรา')],
}
