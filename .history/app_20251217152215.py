...
def is_nearby_province(prov1, prov2):
    ...
    # 🔥 จังหวัดชายแดน (Transition Zones) - รวมทริปได้ระหว่างภาค
    # เช่น สระบุรี ↔ นครราชสีมา, ลพบุรี ↔ ชัยภูมิ
    border_pairs = [
        # ภาคกลาง ↔ อีสาน (ผ่านเขาใหญ่)
        ('สระบุรี', 'นครราชสีมา'), ('สระบุรี', 'โคราช'),
        ('ลพบุรี', 'ชัยภูมิ'), ('ลพบุรี', 'นครราชสีมา'),
        ('นครนายก', 'นครราชสีมา'), ('นครนายก', 'ปราจีนบุรี'),
        # ภาคกลาง ↔ ตะวันออก
        ('ฉะเชิงเทรา', 'สมุทรปราการ'), ('ฉะเชิงเทรา', 'กรุงเทพ'),
        ('ชลบุรี', 'ฉะเชิงเทรา'), ('ชลบุรี', 'สมุทรปราการ'),
        ('ปราจีนบุรี', 'นครนายก'), ('ปราจีนบุรี', 'ฉะเชิงเทรา'),
        # ภาคกลาง ↔ เหนือ (ผ่านนครสวรรค์)
        ('ลพบุรี', 'นครสวรรค์'), ('ชัยนาท', 'นครสวรรค์'),
        ('อุทัยธานี', 'ชัยนาท'), ('อุทัยธานี', 'นครสวรรค์'),
        # ภาคกลาง ↔ ตะวันตก
        ('นครปฐม', 'ราชบุรี'), ('นครปฐม', 'กาญจนบุรี'),
        ('สมุทรสาคร', 'สมุทรสงคราม'), ('สมุทรสงคราม', 'เพชรบุรี'),
    ]
    
    # เช็คว่าเป็นคู่จังหวัดชายแดนหรือไม่
    for p1, p2 in border_pairs:
        if (p1 in str(prov1) and p2 in str(prov2)) or (p2 in str(prov1) and p1 in str(prov2)):
            return True
