...
3. 6W ≥200% Cube → ยอมรับไม่แยก
4. 6W 150-199% Cube → แยกเป็นรถเล็กถ้าทำได้
...
if phase3_check:
    ...
    if "cube_util >= 200" in phase3_code:
        print("✅ พบเงื่อนไข: 6W ≥200% → ยอมรับไม่แยก")
        if "continue" in phase3_code[phase3_code.find("cube_util >= 200"):phase3_code.find("cube_util >= 200")+100]:
            print("✅ ถูกต้อง! ข้ามการแยกเมื่อ ≥200%")
    else:
        print("❌ ไม่พบเงื่อนไข 6W ≥200%")
    
    # ตรวจสอบ 150-199% logic
    if "cube_util >= 150 and cube_util < 200" in phase3_code:
        print("✅ พบเงื่อนไข: 6W 150-199% → พิจารณาแยก")
...
checks = {
    ...
    "Phase 2.1 - 4W เต็มจะตัดเป็น JB": "target_vehicle = 'JB'" in app_code[app_code.find("Phase 2.1"):app_code.find("Phase 2.5")],
    "Phase 3 - 6W ≥200% ยอมรับ": "cube_util >= 200" in app_code,
    "Phase 3 - 6W 150-199% แยกอย่างชาญฉลาด": "cube_util >= 150 and cube_util < 200" in app_code,
