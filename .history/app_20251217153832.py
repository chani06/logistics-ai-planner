...
# 🔥 อำเภอที่ติดกันข้ามจังหวัด (ทางผ่าน)
...
ADJACENT_DISTRICTS = {
    ...
    # นครราชสีมา ↔ ชัยภูมิ
    ('ด่านขุนทด', 'นครราชสีมา'): [('บำเหน็จณรงค์', 'ชัยภูมิ'), ('เทพสถิต', 'ชัยภูมิ')],
    ('เทพารักษ์', 'นครราชสีมา'): [('เทพสถิต', 'ชัยภูมิ')],
    
    # นครราชสีมา ↔ บุรีรัมย์  
    ('หนองกี่', 'นครราชสีมา'): [('หนองกี่', 'บุรีรัมย์'), ('นางรอง', 'บุรีรัมย์')],
    ('ปักธงชัย', 'นครราชสีมา'): [('ครบุรี', 'นครราชสีมา')],
    
    # สระบุรี ↔ ลพบุรี
    ('พระพุทธบาท', 'สระบุรี'): [('โคกสำโรง', 'ลพบุรี'), ('เมืองลพบุรี', 'ลพบุรี')],
    ('เสาไห้', 'สระบุรี'): [('บ้านหมี่', 'ลพบุรี')],
    
    # ชัยภูมิ ↔ ขอนแก่น
    ('ภูเขียว', 'ชัยภูมิ'): [('ชุมแพ', 'ขอนแก่น')],
    ...
    while all_codes:
        ...
        while all_codes:
            ...
            for code in all_codes:
                ...
                # 🔥 "ติดกัน" = ตำบลเดียวกัน หรือ อำเภอเดียวกัน (ไม่ใช่แค่จังหวัด)
                is_adjacent = same_subdistrict or same_district
                
                # 🚨 กฎการรวมสาขาข้ามภาค:
                # 1. ตำบล/อำเภอเดียวกัน → รวมได้เสมอ
                # 2. จังหวัดเดียวกัน → รวมได้
                # 3. ภาคไกล + ภาคกลาง ที่ไม่ติดกัน (ตำบล/อำเภอ) → ห้ามรวม
                ...
                if same_subdistrict:
                    ...
                    # อำเภอเดียวกัน → ยืดหยุ่นเป็น 50km
