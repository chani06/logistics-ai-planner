...
# ลิมิตใหม่: 6W เต็มคิวที่ 19-20
LIMITS = {
    '6W': {'max_c': 20, 'max_w': 9000, 'max_drops': 20},
    'JB': {'max_c': 9, 'max_w': 3500, 'max_drops': 12},
...
FAR_DC_THRESHOLD = 250  # km - บริเวณไกล DC ให้ใช้รถใหญ่
    ...
    while remaining_indices:
        ...
        for idx in remaining_indices[:]:
            ...
            if distance_from_last > MAX_DISTANCE_BETWEEN_BRANCHES:
                ...
                # อัพเกรดรถ
                if truck_type == '4W' and new_cubes <= LIMITS['JB']['max_c']:
                    truck_type = 'JB'
                    max_cubes = LIMITS['JB']['max_c']
                elif truck_type == 'JB' and new_cubes <= LIMITS['6W']['max_c']:
                    truck_type = '6W'
                    max_cubes = LIMITS['6W']['max_c']
                else:
                    should_add = False
