...
EXCLUDE_BRANCHES = ['DC011', 'PTDC', 'DCวังน้อย', 'PTG DISTRIBUTION CENTER']

# รายชื่อที่ต้องตัดออก (ใช้ตรวจสอบชื่อ)
EXCLUDE_NAMES = ['DCวังน้อย', 'Distribution Center', 'PTG Distribution', 'บ.พีทีจี เอ็นเนอยี']
...
def main():
    ...
    with tab2:
        ...
        with col1:
            ...
            ระบบจะจัดทริปโดยใช้กฎ **4 ลำดับความสำคัญ**:
            
            1. **📜 ประวัติการจัดส่ง** (ความแม่นยำ 100%)
               - ถ้าสาขาเคยไปด้วยกันในประวัติ → จัดเข้าทริปเดียวกัน
               - ใช้รถประเภทเดียวกับที่เคยใช้
            
            2. **🚚 ตรวจสอบรถที่สาขาเคยใช้**
               - ตรวจสอบว่าสาขาเคยใช้รถประเภทนี้หรือไม่
               - ถ้าไม่เคยใช้ จะมีคำเตือน ⚠️ แสดง
               - ช่วยให้แน่ใจว่าสาขาสามารถรับรถได้
