...
def get_max_vehicle_for_branch(branch_code):
    ...
    🚨 แก้ไขใหม่: ไม่จำกัด 6W อีกต่อไป - สามารถใช้ 6W ได้ทุกสาขา
    แต่จะใช้พื้นที่ (กรุงเทพ/ปริมณฑล) เป็นตัวกำหนดว่าควรใช้ JB/4W
    """
    # 🚨 ไม่จำกัด 6W อีกต่อไป - ทุกสาขาสามารถใช้ 6W ได้
    return '6W'

def get_max_vehicle_for_trip(trip_codes):
    """
    หารถใหญ่สุดที่ทริปนี้ใช้ได้
    🚨 แก้ไขใหม่: ไม่จำกัด 6W อีกต่อไป - ทุกทริปสามารถใช้ 6W ได้
    """
    return '6W'  # ไม่จำกัดแล้ว
